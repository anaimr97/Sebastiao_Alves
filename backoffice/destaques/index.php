        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">DESTAQUES</h2>
                        </div>
                    </div>
                            ...
                            <table>
                                ...
                                <?php foreach($destaques as $d): ?>
                                    ...
                                    <tr> 
                                        ...
                                        <td><img class="carousel-listar-imagem-desktop" src="<?= $livro["imagem"]; ?>" alt=""></td> 
                                        
                                        <td><b><?= $livro["titulo"]; ?></b></td>                                       
                                        ...
                                        <td>
                                            <?= ($d["estado"]) ? "Ativo" : "Desativo"; ?>                                          
                                        </td>

                                        <td>
                                            <a href="editar.php?id=<?= $d["id"]; ?>" title="Editar">
