<?php
    ...
    $form = isset($_GET["imagem_autor"]) && isset($_GET["texto_ultimos_livros"]);

    if($form){

        $form = !empty($_GET["imagem_autor"]) && !empty($_GET["texto_ultimos_livros"]);
        ...
        if($form){
            ...
            iduSQL("UPDATE home SET imagem_autor='$imagem_autor', texto_ultimos_livros='$texto_ultimos_livros' WHERE id=1");
        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <header class="container inicio-header-caixa">
                    ...
                    <div class="row inicio-header-navbar">
                        ...
                        <div class="col-auto mx-auto">
                            ...
                            <a class="inicio-header-link active" href="index.php">Home</a>
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">EDITAR HOME</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <?php if(empty($mensagem)):?>
                                ...
                                <form action="" class="text-center">
                                    ...
                                    <br>
                                    <input class="input-editar" type="text" name="imagem_autor" style="width: 85%;" required="required" value="<?= $home["imagem_autor"]; ?>">
                                    ...
                                    <label for="texto_ultimos_livros" class="mb-2"><b>Texto Últimos Livros:</b></label>
                                    <textarea id="editor" class="input-editar" name="texto_ultimos_livros" required="required"><?= $home["texto_ultimos_livros"]; ?></textarea>
