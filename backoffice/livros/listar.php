        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <header class="container inicio-header-caixa">
                    ...
                    <div class="row inicio-header-navbar">
                        ...
                        <div class="col-auto mx-auto">
                            ...
                            <a class="inicio-header-link active" href="index.php">Livros</a>
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">LIVROS - LISTA</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-12 d-flex justify-content-center">
                            ...
                            <table>
                                ...
                                <?php foreach($livros as $l): ?>
                                    ...
                                    <?php $nome_usuario = getUsuarioID($l["id_usuario_editou"]); ?>

                                    <tr>
                                        <td><img class="carousel-listar-imagem-desktop" src="<?= $l["imagem"]; ?>" alt=""></td>
                                        <td><b><?= $l["titulo"]; ?></b></td>
                                        <td><?= substr($l["descricao"], 0, 50);?><?= (strlen($l["descricao"]) > 50) ? "..." : "" ?></td>
                                        <td>
                                            <?php if(!empty($l["ultima_edicao"])):?>
                                                <?=$l["ultima_edicao"]?>
                                            <?php endif;?>
                                            <hr class="linha">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col">
                            ...
                            <a href="criar.php">
                                <button class="index-header-login-botao mb-4">Novo livro</button>
                            </a>
