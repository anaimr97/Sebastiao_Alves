<?php
    ...
    elseif(isset($_GET["apagar"])){
        ...
        if(!empty($_GET["apagar"])){
            ...
            $livro_apagar = selectSQLUnico("SELECT * FROM livros WHERE id='$id'");

            if(!empty($livro_apagar)){

                iduSQL("DELETE FROM livros WHERE id='$id'");

                $mensagem = "SUCESSO! LIVRO APAGADO";

            }
            else{
                $mensagem = "ERRO! LIVRO NÃO CADASTRADO"; 
            }
        }
        else{
            header("Location: listar.php");
        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">APAGAR LIVRO</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <?php if($form):?>
                                ...
                                <h5 class="mensagem">Tem certeza que desejas apagar o livro "<u><?= $livro["titulo"] ?></u>"?</h5>
