<?php
    ...
    if($form){
        ...
        // $form = !empty($_GET["instagram"]) && !empty($_GET["facebook"]) && !empty($_GET["linkedin"]);
        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <header class="container inicio-header-caixa">
                    ...
                    <div class="row inicio-header-navbar">
                        ...
                        <div class="col-auto mx-auto">
                            ...
                            <a class="inicio-header-link active" href="index.php">Redes</a>
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">EDITAR REDES SOCIAIS</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <?php if(empty($mensagem)):?>
                                ...
                                <form action="" class="text-center">
                                    ...
                                    <label for="instagram" class="mb-2"><b>Instagram</b> <small>(Para desativar deixe em branco)</small></label>
                                    <br>
                                    <input class="input-editar" type="text" name="instagram" style="width: 90%;" <?= (empty($redes["instagram"]) ? "" : "value='$redes[instagram]'") ?>>
                                    
                                    <br><br>                                    

                                    <label for="facebook" class="mb-2"><b>Facebook</b> <small>(Para desativar deixe em branco)</small></label>
                                    <br>
                                    <input class="input-editar" type="text" name="facebook" style="width: 90%;" <?= (empty($redes["facebook"]) ? "" : "value='$redes[facebook]'") ?>>
                                    
                                    <br><br> 

                                    <label for="linkedin" class="mb-2"><b>Linkedin</b> <small>(Para desativar deixe em branco)</small></label>
                                    <br>
                                    <input class="input-editar" type="text" name="linkedin" style="width: 90%;" <?= (empty($redes["linkedin"]) ? "" : "value='$redes[linkedin]'") ?>>
