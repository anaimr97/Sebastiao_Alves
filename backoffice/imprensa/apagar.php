<?php
    ...
    if(isset($_GET["id"])){
        ...
        if(!empty($_GET["id"])){
            ...
            $post = selectSQLUnico("SELECT * FROM imprensa WHERE id='$id'");
    ...
    elseif(isset($_GET["apagar"])){
        ...
        if(!empty($_GET["apagar"])){
            ...
            $post_apagar = selectSQLUnico("SELECT * FROM imprensa WHERE id='$id'");

            if(!empty($post_apagar)){

                iduSQL("DELETE FROM imprensa WHERE id='$id'");

                $mensagem = "SUCESSO! POST APAGADO";

            }
            else{
                $mensagem = "ERRO! POST NÃO CADASTRADO"; 
            }
        }
        else{
            header("Location: listar.php");
        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">APAGAR POST IMPRENSA</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <?php if($form):?>
                                ...
                                <h5 class="mensagem">Tem certeza que desejas apagar o post "<u><?= $post["titulo"] ?></u>"?</h5>
