        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                            <h2 class="carouse-editar-titulo text-center mb-0">AUTOR</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            ...
                            <img src="<?= $autor["imagem_autor"]?>" alt="Imagem autor" width="300px">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            ...
                            <h5 class="mensagem">Texto do Autor</h5>

                            <div class="autor-paragrafo m-0">
                                <?= $autor["texto_autor"]?>
                            </div>
