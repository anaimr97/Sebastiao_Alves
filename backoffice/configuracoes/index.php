        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">CONFIGURAÇÕES</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <form action="saida.php" method="post">
                                ...
                                <label for="senha_nova_confirmacao">Digite novamente a Nova Senha: </label>
                                <br>
                                <input type="password" name="senha_nova_confirmacao" required="required">


                                <br><br><br>

                                <input class="index-header-login-botao" type="submit" value="Alterar">
