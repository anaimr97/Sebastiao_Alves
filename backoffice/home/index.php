        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                            <h2 class="carouse-editar-titulo text-center mb-0">HOME</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            ...
                            <h5 class="mensagem mb-3">Imagem do autor</h5>

                            <img src="<?= $home["imagem_autor"]?>" alt="Imagem autor" width="300px">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            ...
                            <h5 class="mensagem">Texto "Últimos Livros"</h5>

                            <p class="home-paragrafo m-0">
