        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">CAROUSEL - LISTA</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-12 d-flex justify-content-center">
                            ...
                            <table>
                                ...
                                <?php foreach($carousel as $c): ?>
                                    ...
                                    <?php $nome_usuario = getUsuarioID($c["id_usuario_editou"]); ?>

                                    <tr>
                                        <td><?= $c["posicao"]; ?></td>
                                        <td><b><?= $c["titulo"]; ?></b></td>
                                        <td><?= substr($c["descricao"], 0, 50);?><?= (strlen($c["descricao"]) > 50) ? "..." : "" ?></td>
                                        <td><img class="carousel-listar-imagem-desktop" src="<?= $c["imagem_desktop"]; ?>" alt=""></td>
                                        <td><img class="carousel-listar-imagem-mobile" src="<?= $c["imagem_mobile"]; ?>" alt=""></td>
                                        <td>
                                            <?php if(!empty($c["ultima_atualizacao"])):?>
                                                <?=$c["ultima_atualizacao"]?>
                                            <?php endif;?>
                                            <hr class="linha">
                                            Feito por: <?=$nome_usuario["nome"]?>
                                        </td>
                                        <td>
                                            <a href="editar.php?id=<?= $c["id"]; ?>" title="Editar">

                                                <img class="carousel-listar-icon" src="../../public/Imagens/Backoffice/icon-editar.svg" alt="icon editar">

                                            </a>

                                            <a href="apagar.php?id=<?= $c["id"]; ?>" title="Apagar">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col">
                            ...
                            <a href="criar.php">
                                <button class="index-header-login-botao mb-4">Novo Banner</button>
                            </a>
