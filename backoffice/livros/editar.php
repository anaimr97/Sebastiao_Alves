<?php
    ...
    if(isset($_GET["id"])){
        ...
        if(!empty($_GET["id"])){
            ...
            $form = isset($_GET["id"]) && isset($_GET["titulo"]) && isset($_GET["imagem"]) && isset($_GET["descricao"]) && isset($_GET["detalhes"]);

            if($form){

                $form = !empty($_GET["id"]) && !empty($_GET["titulo"]) && !empty($_GET["imagem"]) && !empty($_GET["descricao"]);
                ...
                if($form){
                    ...
                    iduSQL("UPDATE livros SET titulo='$titulo', imagem='$imagem', descricao='$descricao', detalhes='$detalhes', ultima_edicao='$data_atual', id_usuario_editou='$ultimo_usuario_editar' WHERE id='$_GET[id]'");
        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">LIVROS - EDITAR</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <?php if(!$form):?>
                                ...
                                <form action="" class="text-center">
                                    ...
                                    <br>
                                    <input class="input-editar" type="text" name="imagem" style="width: 85%;" required="required" value="<?= $livro_especifico["imagem"]; ?>">
                                    ...
                                    <textarea id="editor" class="input-editar" name="descricao" ><?= $livro_especifico["descricao"]; ?></textarea>
                                    ...
                                    <textarea id="editor-detalhes" class="input-editar" name="detalhes" ><?= $livro_especifico["detalhes"]; ?></textarea>
