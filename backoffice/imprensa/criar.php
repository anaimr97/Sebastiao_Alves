<?php
    ...
    if($form){
        ...
        if($form){
            ...
            iduSQL("INSERT INTO imprensa (titulo, data_publicacao, imagem, texto) VALUE ('$titulo','$data', '$imagem', '$texto')");

            $mensagem = "SUCESSO! POST DE IMPRENSA CRIADO";
        ...
        <div class="margem content">
            ...
            <div class="sombra">
                ...
                <main class="container inicio-main">
                    ...
                    <div class="row">
                        <div class="col">
                        <h2 class="carouse-editar-titulo text-center">CRIAR POST IMPRENSA</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <?php if(empty($mensagem)):?>
                                ...
                                <form action="" class="text-center">
                                    ...
                                    <br>
                                    <input class="input-editar" type="date" name="data" style="width: 90%;" required="required" value="<?= date('Y-m-d'); ?>">
                                    
                                    <br><br>

                                    <label for="imagem"><b>Link da imagem do post:</b></label>
                                    <br>
                                    <input class="input-editar" type="text" name="imagem" style="width: 85%;">
                            ...
                            <?php else: ?>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="criar.php">
                                        <button class="index-header-login-botao mb-3">Criar novo post</button>
                                    </a>
